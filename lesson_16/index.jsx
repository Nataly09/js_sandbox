...
class Authorize extends React.Component {
    ...
    CurrentStep(props) {
        switch (props.step) {
            ...
            case SECONDSTEP: return <Registration_1 nextStep={props.handler} update={props.reg1} />;
            case THIRTSTEP: return <Registration_2 nextStep={props.handler} update2={props.reg2} serverPush={props.toPost} />;
    ...
    render() {
        return (
            <div>
                <this.CurrentStep step={this.state.step} handler={this.nextStep.bind(this)} reg1={this.update.bind(this)} reg2={this.update2.bind(this)}
                    toPost={this.serverPush.bind(this)}></this.CurrentStep>
            </div>
        )
