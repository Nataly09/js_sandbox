...
// ((num, title = null) =>window.addEventListener('keydown', enter =>
//     enter.keyCode == 13 && ++num && (div.innerHTML += `<div>
//     <label for="${num}checkbox">${input.value.replace('<', '&lt;')}</label>
//     <input type="checkbox" id="${num}checkbox">
//     </div>`) && (title = input.value)))(0);
